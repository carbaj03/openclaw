...
export function createCanvasTool(options?: { config?: OpenClawConfig }): AnyAgentTool {
  ...
  return {
    ...
    description: [
      ...
      '  Column  — {"children":{"explicitList":["id1","id2"]},"distribution":"start|center|end|spaceBetween|spaceEvenly"}',
      '  Row     — {"children":{"explicitList":["id1","id2"]},"distribution":"..."}',
      ...
      '  {"surfaceUpdate":{"surfaceId":"main","components":[{"id":"card","component":{"Card":{"child":"col"}}},{"id":"col","component":{"Column":{"children":{"explicitList":["t1","t2"]}}}},{"id":"t1","component":{"Text":{"text":{"literalString":"Title"},"usageHint":"h3"}}},{"id":"t2","component":{"Text":{"text":{"literalString":"Body text"},"usageHint":"body"}}}]}}',
      "",
